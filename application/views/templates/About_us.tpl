                                        ...
                                        <div class="form-group">                                            
                                            <div class="col-md-12">
                                                <div class="inputer">
                                                    ...
                                                    <textarea class="form-control summernote" name="passenger_content">{$about_array['passenger_content']}</textarea>
                                                    </div>
                                    ...
                                    <div class="form-content">                                        
                                        <div class="form-group">                                            
                                            <div class="col-md-12">
                                                <div class="inputer">
                                                    <div class="input-wrapper">
                                                        <textarea class="form-control summernote" name="pilot_content">{$about_array['driver_content']}</textarea>
                                                    </div>
