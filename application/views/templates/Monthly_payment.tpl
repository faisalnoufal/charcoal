    ...
    <div class="col-md-12">
        ...
        <div class="panel">
            <!-- <div class="panel-heading">
                <div class="panel-title"><h3>Monthly Payment Report</h3></div>
            </div> --><!--.panel-heading-->
                ...
                <form action="" class="form-horizontal form-striped form-bordered parsley-validate" method="post">
                    <div class="form-content">
                         ...
                         <div class="form-group">
                            <label class="control-label col-md-3">Select Pilot<span style="color: red;vertical-align:super;font-size:small"> *</span></label>
                            <div class="col-md-5">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel" style="font-size: small">
                        <div class="panel-heading">
                            <div class="panel-title"><h4>Monthly Payment Details {if isset($user_fullname)}{strtoupper($user_fullname)}{/if}</h4></div>
                        </div><!--.panel-heading-->
                        <div class="panel-body">
                                ...
                                <table class="display datatables-basic dataTable">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr style="text-align:left;font-size: 18px">
                                            <td colspan="5">
                                                <form method="post" action="{$base_url}Excel/Monthly_payment">
                                                    <input type="hidden" name="from_to_date" value="{$from_to_date}">
                                                    <input type="hidden" name="user_id" value="{$driver_id}">
