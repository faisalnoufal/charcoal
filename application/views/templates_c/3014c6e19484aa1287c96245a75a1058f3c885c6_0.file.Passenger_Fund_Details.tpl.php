<?php /* Smarty version 3.1.27, created on 2016-04-15 10:06:26
         compiled from "/home/ajoul/public_html/sites/admin/application/views/templates/Passenger_Fund_Details.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:16745734035710bd225ac933_38475309%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3014c6e19484aa1287c96245a75a1058f3c885c6' => 
    array (
      0 => '/home/ajoul/public_html/sites/admin/application/views/templates/Passenger_Fund_Details.tpl',
      1 => 1459495746,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16745734035710bd225ac933_38475309',
  'variables' => 
  array (
    'plugin_path' => 0,
    'css_path' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5710bd22608fa3_62455853',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5710bd22608fa3_62455853')) {
function content_5710bd22608fa3_62455853 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '16745734035710bd225ac933_38475309';
    ...
    <div class="col-md-12">
        ...
        <div class="panel">
            <!-- <div class="panel-heading">
                <div class="panel-title"> <h3>Customer Ewallet History</h3></div>
            </div> --><!--.panel-heading-->
...
?>
                                        ...
                                        <?php } elseif ($_smarty_tpl->tpl_vars['v']->value['amount_type'] == "admin_debit") {?>
                                            ...
                                            <?php $_smarty_tpl->tpl_vars['balance'] = new Smarty_Variable($_smarty_tpl->tpl_vars['balance']->value-$_smarty_tpl->tpl_vars['v']->value['amount'], null, 0);?>
                                        <?php } elseif ($_smarty_tpl->tpl_vars['v']->value['amount_type'] == "Trip Cancel") {?>
                                            <?php $_smarty_tpl->tpl_vars['amount_type'] = new Smarty_Variable("Trip Cancel", null, 0);?>
                                            <?php $_smarty_tpl->tpl_vars['balance'] = new Smarty_Variable($_smarty_tpl->tpl_vars['balance']->value-$_smarty_tpl->tpl_vars['v']->value['amount'], null, 0);?>
                                        <?php } elseif ($_smarty_tpl->tpl_vars['v']->value['amount_type'] == "Driver Added") {?>
                                            <?php $_smarty_tpl->tpl_vars['amount_type'] = new Smarty_Variable("Pilot Added", null, 0);?>
                                            <?php $_smarty_tpl->tpl_vars['balance'] = new Smarty_Variable($_smarty_tpl->tpl_vars['balance']->value+$_smarty_tpl->tpl_vars['v']->value['amount'], null, 0);?>
                                        <?php } elseif ($_smarty_tpl->tpl_vars['v']->value['amount_type'] == "Referral Point") {?>
                                            ...
                                            <?php $_smarty_tpl->tpl_vars['balance'] = new Smarty_Variable($_smarty_tpl->tpl_vars['balance']->value+$_smarty_tpl->tpl_vars['v']->value['amount'], null, 0);?>
                                        <?php } elseif ($_smarty_tpl->tpl_vars['v']->value['amount_type'] == "Trip Payment") {?>
                                        ...
                                        <?php $_smarty_tpl->tpl_vars['total'] = new Smarty_Variable($_smarty_tpl->tpl_vars['total']->value+$_smarty_tpl->tpl_vars['v']->value['amount'], null, 0);?>
